...
def load_system_prompt():
    with open(r"C:\Users\Aarya-2\Documents\ADOG\MARLOW AI\QGED_CODEX_M_L\GREM\Baseline_Test\Context\Context.md", "r") as f:
        context = f.read()
    with open(r"C:\Users\Aarya-2\Documents\ADOG\MARLOW AI\QGED_CODEX_M_L\GREM\Baseline_Test\Context\Agent_A.md", "r") as f:  # FIX: was Agent_A.py
        agent = f.read()
    return context + "\n\n" + agent
...
@traceable(name="agent_a_record", tags=["agent_a", "groq"])
